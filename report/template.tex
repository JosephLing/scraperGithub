...
However it does contain the data on the Cloud Bees projects which is 223 projects. As far as we can tell this only effects the comparison done in RQ2 \ref{section:RQ2}. This because in their RQ1, RQ2 they only do the it based the data that they gave us. \todo[]{check RQ2 when you create the scatter}
