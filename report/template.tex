...
\subsubsection{configuration errors when loading the config (just yaml parsing errors atm)}
\subsubsection{How are comments used in configuration?}
\subsubsection{How are stages used in configuration?}
 and looking into branches
 \subsubsection{How are script tags used?}
